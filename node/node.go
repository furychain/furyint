...
import (
	...
	"github.com/xblackfury/furyint/block"
	"github.com/xblackfury/furyint/config"
	"github.com/xblackfury/furyint/da"
	daregsitry "github.com/xblackfury/furyint/da/registry"
...
// Node represents a client node in Furyint network.
...
func NewNode(ctx context.Context, conf config.NodeConfig, p2pKey crypto.PrivKey, signingKey crypto.PrivKey, clientCreator proxy.ClientCreator, genesis *tmtypes.GenesisDoc, logger log.Logger) (*Node, error) {
	...
	if conf.RootDir == "" && conf.DBPath == "" { // this is used for testing
		...
		// TODO(omritoptx): Move furyint to const
		baseKV = store.NewDefaultKVStore(conf.RootDir, conf.DBPath, "furyint")
	}
