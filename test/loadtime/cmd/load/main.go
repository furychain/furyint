...
func main() {
	...
	loadtest.Run(&loadtest.CLIConfig{
		...
		AppLongDesc:          "loadtime generates transaction load for the purpose of measuring the end-to-end latency of a transaction from submission to execution in a Furyint network.",
